...
struct Details{
    ...
    static let FluxPavilion = DetailItem(title: "FluxPavilion", image: "FluxPavilion.jpeg", description: "Joshua Steele, known professionally as Flux Pavilion, is an English dubstep producer and DJ. He is the co-founder of Circus Record.")
